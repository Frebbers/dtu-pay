Feature: create account
    Background:
    Given user with CPR "240396-8179" is cleaned up
    And user with CPR "120394-4827" is cleaned up
    Scenario: Successful customer Account Creation
        Given a customer with name "Susan", last name "Baldwin", and CPR "240396-8179"
